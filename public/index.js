...
// Gestion de l'affichage de l'en-tête au scroll (changement de style, pas de mouvement)
...
// --- GESTION DU COMPTEUR ET DU BOUTON "JE SUIS PARTANT" (MIS À 0) ---
...
async function handlePartantClick() {
    ...
    try {
        ...
        let currentCount = parseInt(localStorage.getItem('localPartantCount') || '0', 10) + 1;
